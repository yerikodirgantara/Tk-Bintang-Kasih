<template>
  <div class="form-container">
    <h1>Formulir Data Orang Tua Ibu Peserta Didik KB Bintang Kasih</h1>
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      // Kembalikan formData ke nilai default
      this.formData = this.getDefaultFormData();
      this.file = null;
      this.fileError = '';
    },
    goBack() {
      this.$router.push('/Ayahsiswa'); // Mengarahkan ke path formulir ayah
    }
  }
}
</script>
