<template>
  <footer class="py-4">
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-md-6 mb-4 contact-info text-left" data-aos="fade-right">
          ...
          <p class="mb-3" data-aos="fade-right" data-aos-delay="200">
            ...
            <a href="https://wa.me/6282225386373" class="text-white">
              +62 822 2538 6373
            </a>
          </p>
      ...
      <p class="footer-text mt-3 text-center">©2024 KB & TK Bintang Kasih | All Rights Reserved</p>
    </div>
  </footer>
</template>
...
<style scoped>
footer {
  background: linear-gradient(135deg, #7f86d4, #d4bff9); /* Warna yang diberikan */
  color: #fff;
...
/* Styling untuk ikon dan teks kontak */
.contact-info p {
  font-size: 1rem;
  line-height: 1.6;
...
.contact-info a:hover, .social-media a:hover {
  color: #ffd700; /* Warna hover untuk link */
}
...
.social-icon:hover {
  background-color: #a41e1d; /* Warna saat di-hover */
  color: #000; /* Warna ikon tetap hitam saat hover */
}

/* Styling untuk teks hak cipta di bagian bawah */
.footer-text {
  font-size: 0.9rem;
